...
<body class="antialiased h-screen w-screen pb-9 px-1 pt-2 bg-newspaper">
    ...
    <div class="overflow-y-scroll overflow-x-hidden border-2
        ...
        <form method="POST" action="/register" class="border-2 border-neutral-700 w-3/4 max-w-md px-4 py-6
                         mb-10">
            @csrf
            ...
            <div class="flex flex-col mb-6">
                ...
                <input class="bg-newspaper border border-dashed p-1
                                  border-neutral-500" type="text" name="name" value="{{old('name')}}" placeholder="trout89" />
            ...
            <div class="flex flex-col mb-6">
                <label type="email" class="font-semibold text-sm mb-1">EMAIL</label>
                <input class="bg-newspaper border border-dashed p-1
                                  border-neutral-500" type="text" name="email" value="{{old('email')}}" placeholder="email@ex.com" />
            ...
            <div class="flex flex-col mb-6">
                ...
                <input class="bg-newspaper border border-dashed p-1
                                  border-neutral-500" name="password" type="password" placeholder="NOT 'password'" />
            ...
            <div class="flex flex-col mb-10">
                ...
                <input class="bg-newspaper border border-dashed p-1
                                  border-neutral-500" type="password" name="password_confirmation" placeholder="NOT 'trout89123'" />
            </div>
