<div>
    <form class="flex flex-col" @change="$refs.availability.requestSubmit()" @submit.prevent.stop="$dispatch( 'data', {'category': categoryName,
                                                    'data': await getByFilter.submit()})" x-ref="availability">
        ...
        <div class="mx-4 my-2">
            ...
            <div @click="price = !price" class="font-semibold hover-text flex relative">
                ...
                <span x-show="price" class="inline-block rotate-90 cursor-pointer absolute
                             top-0 left-0">></span>

                <span class="cursor-pointer ml-7 ">PRICE</span>
            </div>

            <div x-show="price" class="ml-7 h-fit">

                <div x-init="range.mintrigger(); range.maxtrigger()" class="w-full mt-4">

                    <div class="relative w-full h-fit border border-dashed border-neutral-700 ">
                        <div class="absolute top-0 rounded-full h-1
                                    -translate-y-1/2 bg-neutral-700" :style="'right:'+range.maxthumb+'%; left:'+range.minthumb+'%'"></div>

                        <input type="range" :min="range.min" :max="range.max" @input="range.mintrigger()" x-model="range.minprice" />

                        <input type="range" :min="range.min" :max="range.max" @input="range.maxtrigger()" x-model="range.maxprice" />


                    </div>
                <div class="flex w-full justify-between pt-5">
                    <p class="border border-dashed border-neutral-700 px-2
                                  font-semibold" x-text="`€ ${range.minprice}`"></p>

                    <p class="border border-dashed border-neutral-700 px-2
                                  font-semibold" x-text="`€ ${range.maxprice}`"></p>
        ...
        <div class="mx-4 my-2">
            ...
            <div @click="available = !available" class="font-semibold hover-text flex relative">
                ...
                <span x-show="available" class="inline-block rotate-90 cursor-pointer absolute
                             top-0 left-0">></span>
        ...
        <div class="mx-4 my-2">
            <div @click="rating = !rating" class="font-semibold hover-text flex relative">
                ...
                <span x-show="rating" class="inline-block rotate-90 cursor-pointer  absolute
                             top-0 left-0">></span>
            ...
            <div x-show="rating" class="ml-7">
                ...
                <div id="5" @click="[getByFilter.formData.minRating = 5,
                              getByFilter.formData.maxRating = 6,
                              $refs.availability.requestSubmit(),
                              chosenRating = 5]" :class="chosenRating == $el.id ? 'chosen-rating' : ''" class="flex items-center my-2 cursor-pointer">
                ...
                <div id="4" @click="[getByFilter.formData.minRating = 4,
                              getByFilter.formData.maxRating = 5,
                              $refs.availability.requestSubmit(),
                              chosenRating = 4]" :class="chosenRating == $el.id ? 'chosen-rating' : ''" class="flex items-center my-2 cursor-pointer">
                ...
                <div id="3" @click="[getByFilter.formData.minRating = 3,
                              getByFilter.formData.maxRating = 4,
                              $refs.availability.requestSubmit(), chosenRating = 3]" :class="chosenRating == $el.id ? 'chosen-rating' : ''" class="flex items-center my-2 cursor-pointer">
                ...
                <div id="2" @click="[getByFilter.formData.minRating = 2,
                              getByFilter.formData.maxRating = 3,
                              $refs.availability.requestSubmit(),
                              chosenRating = 2]" :class="chosenRating == $el.id ? 'chosen-rating' : ''" class="flex items-center my-2 cursor-pointer">
                ...
                <div id="1" @click="[getByFilter.formData.minRating = 1,
                              getByFilter.formData.maxRating = 2,
                              $refs.availability.requestSubmit(),
                              chosenRating = 1]" :class="chosenRating == $el.id ? 'chosen-rating' : ''" class="flex items-center my-2 cursor-pointer">
                ...
                <div @click="[getByFilter.formData.minRating = '',
                              ...
                              chosenRating = '',
                              $refs.availability.requestSubmit()]" class="w-fit bg-neutral-700 flex items-center my-2
