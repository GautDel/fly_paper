...
<nav x-show="open" @click.outside="open = false"
    class="border-r-2 border-t-2 border-b-2 border-neutral-700 flex flex-col bg-newspaper">
        <div @click="notes = true; logs = false" class="border-b-2 border-neutral-700 flex justify-center items-center grow cursor-pointer hover-text ">
            <p class="px-4 py-4 font-normal text-sm">NOTES</p>
        </div>
        <div @click="notes = false; logs = true" class="flex justify-center items-center grow cursor-pointer hover-text ">
