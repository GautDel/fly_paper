@auth
<div class="flex flex-col justify-start items-end" x-data="{
    ...
    <form @submit="postVote.up($event)">
        ...
        <button type="submit" :class="upvoted == 1 ? 'text-blue-900' : 'text-neutral-700'" class="rotate-90 font-bold text-lg hover-text" @click="[upvoted = 1, downvoted = 0]">
            < </button>
    </form>
